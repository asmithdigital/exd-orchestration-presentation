      ...
      <div style={{ padding: "0 40px", minWidth: "max-content" }}>
        ...
        <Section>
          ...
          <Flow>
            ...
            <NL nodeProps={{ label: "GitHub", sub: "Create repos, push code, deploy to GitHub Pages", color: C.github, bg: C.githubBg, border: C.githubBorder, icon: "⬡", status: "live" }} linkLabel="Product Repo" linkUrl="https://github.com/asmithdigital/ux-workflow-outputs" />
            <Arrow color={C.slack} />
